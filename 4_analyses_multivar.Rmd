...
ggsave(file="output/figures/fig1.tiff", plot=fig1, width=8, height=8,dpi=300,
       compression="lzw")
```
...
# New Fig. 1 (comb. with old Fig. 2)

```{r}
fig1_newA<-grid.arrange(
  ggplot(curves%>%filter(moment=="Mean"),aes(x=value,fill=curve_id))+
    geom_density(alpha=0.5)+my_theme_legend()+theme(legend.position="top")+
    labs(fill="Mean")+xlab("Opening date")+ylab("Density")+ggtitle("A)")+
    scale_fill_manual(values=c("#1a9641","#ffffbf","#d7191c"),
...
fig1_newB<-grid.arrange(
  # Mean
  ggplot(data_ids,aes(x=avFD_v))+
    #geom_density(fill="grey")+
    geom_histogram(color="black",alpha=0.3,position="identity")+
    my_theme()+xlab("Mean")+ylab(NULL)+
    geom_vline(xintercept=63.2,color="#1a9641",size=1.5,alpha=1)+
    geom_vline(xintercept=66.2,color="#ffffbf",size=1.5,alpha=1)+
    geom_vline(xintercept=69.2,color="#d7191c",size=1.5,alpha=1)+
    theme(plot.title=element_text(hjust=-0.2,vjust=-4)),
  # Variance
  ggplot(data_ids,aes(x=var))+
    #geom_density(fill="grey")+
    ...
    geom_vline(xintercept=0.05,color="#1a9641",size=1.5,alpha=1)+
    geom_vline(xintercept=0.5,color="#ffffbf",size=1.5,alpha=1)+
    geom_vline(xintercept=3,color="#d7191c",size=1.5,alpha=1)+
    theme(plot.title=element_text(hjust=-0.2,vjust=-4)),
  # Skewness
  ggplot(data_ids,aes(x=skew))+
    #geom_density(fill="grey")+
    ...
    geom_vline(xintercept=-1.1,color="#1a9641",size=1.5,alpha=1)+
    geom_vline(xintercept=0.0,color="#ffffbf",size=1.5,alpha=1)+
    geom_vline(xintercept=1.1,color="#d7191c",size=1.5,alpha=1)+
    theme(plot.title=element_text(hjust=-0.2,vjust=-4)),
  # Kurtosis
  ggplot(data_ids,aes(x=kurt))+
    #geom_density(fill="grey")+
    ...
    geom_vline(xintercept=2.0,color="#1a9641",size=1.5,alpha=1)+
    geom_vline(xintercept=3.0,color="#ffffbf",size=1.5,alpha=1)+
    geom_vline(xintercept=6.3,color="#d7191c",size=1.5,alpha=1)+
    theme(plot.title=element_text(hjust=-0.2,vjust=-4)),
  ncol=4,widths=c(0.25,0.25,0.25,0.25),
  left=textGrob("Count",
                gp=gpar(fontsize=14,fontfamily="serif"),rot = 90))

fig1_new<-grid.arrange(fig1_newA,fig1_newB,nrow=2,
                       heights=c(0.55,0.45))
ggsave(file="output/figures/fig1_new.tiff",plot=fig1_new,width=15,height=8,
...
## Appendix 3: Proportions of variance
...
ggsave(file="output/figures/Appendix3.tiff", width=4, height=3.5)
```

# Appendix 4: Differences in moments among years
...
Appendix4
ggsave(Appendix4,
       filename="output/figures/Appendix4.tiff",
       device="tiff",width=20,height=20,units="cm",dpi=300,compression="lzw")
```

# Appendix 5: Correlations of the 4 moments using all data
...
ggsave(filename="output/figures/Appendix5.tiff",
       device="tiff",width=10,height=8,units="cm",dpi=300,compression="lzw")
```

# Appendix 6: Correlations of the 4 moments for each year
...
Appendix6<-grid.arrange(
  ...
  data_ids%>%dplyr::select(year,avFD_v,var,skew,kurt) %>%
    ...
    my_theme()+xlab(NULL)+ylab(NULL),
  ncol=3)
ggsave(Appendix6,filename="output/figures/Appendix6.tiff",
       device="tiff",width=25,height=10,units="cm",dpi=300,compression="lzw")
```

OK? Check VIFs of each model.

# Appendix 7: Differences in fitness components among years
...
Appendix7
ggsave(Appendix7,
       filename="output/figures/Appendix7.tiff",
       device="tiff",width=20,height=20,units="cm",dpi=300,compression="lzw")
```
...
## Appendix 8: Global models phenotypic selection with n_fl
...
ggsave(file="output/figures/fig3.tiff", plot=fig3, width=8, height=8,dpi=300,
       compression="lzw")
```

## Appendix 9: Global models ABSOLUTE FITNESS ~ ABSOLUTE TRAITS
...
## Appendix 10: Yearly models ABSOLUTE FITNESS ~ ABSOLUTE TRAITS
...
## Appendix 11: Global models without n_fl
...
## Appendix 12: Global models fruit initiation, fruit maturation and proportion of seeds escaping predation
...
## Appendix 13: Yearly models fruit initiation
...
## Appendix 14: Effects on fruit initiation
...
ggsave(file="output/figures/Appendix14.tiff",plot=Appendix14,width=10,height=10)
```


## Appendix 15: Yearly models proportion of seeds escaping predation
...
## Appendix 16: Effects on proportion of seeds escaping predation
...
## Appendix 17: Yearly models fruit maturation
...
## Appendix 18: Effects on fruit maturation
...
fig4
ggsave(file="output/figures/fig4.tiff", plot=fig4, width=8, height=10,dpi=300,
       compression="lzw")
```

# Appendix 19: Variation in temperature and number of flowers opening
...
ggsave(file="output/figures/Appendix19.tiff", plot=Appendix19,
       width=10, height=12)
ggsave(file="output/figures/Appendix19.svg", plot=Appendix19,
