...
# Appendix 3: Histograms of the moments for all years

```{r}
Appendix3<-grid.arrange(
  # Mean
  ...
  ncol=2)
ggsave(Appendix3,filename="output/figures/Appendix3.tiff",
       device="tiff",width=20,height=15,units="cm",dpi=300,compression="lzw")
```

# Appendix 4: Histograms of the moments for each year
...
Appendix4<-grid.arrange(
  ...
  ggplot(data_ids,aes(x=kurt,fill=year))+
    ...
    my_theme()+xlab("Kurtosis")+ylab("Count"),
  ncol=2)
ggsave(Appendix4,filename="output/figures/Appendix4.tiff",
