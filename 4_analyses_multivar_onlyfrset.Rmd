...
# Appendix 3: Correlations of the 4 moments using all data
...
# Appendix 4: Correlations of the 4 moments for each year

```{r}
Appendix6_legend<-get_legend(
  data_ids%>%dplyr::select(year,avFD_v,var,skew,kurt) %>%
    filter(year==1987) %>%
    rename(Mean=avFD_v,Variance=var,Skewness=skew,Kurtosis=kurt)%>%
    select_if(is.numeric) %>% 
...
## Appendix 5: Global models phenotypic selection with n_fl
...
## Appendix 6: Global models ABSOLUTE FITNESS ~ ABSOLUTE TRAITS
...
## Appendix 7: Yearly models ABSOLUTE FITNESS ~ ABSOLUTE TRAITS
...
## Appendix 8: Global models without n_fl
...
## Appendix 9: Global models fruit set and proportion of seeds escaping predation
...
##  Appendix 10: Figure effects on fruit set
...
ggsave(file="output/figures/Appendix10.tiff",plot=Appendix10,width=10,height=10)
```

## Appendix 11: Figure effects on proportion of seeds escaping predation
...
# Appendix 12: Variation in temperature and number of flowers opening
...
ggsave(file="output/figures/Appendix12.tiff", plot=Appendix12,
       width=10, height=12)
ggsave(file="output/figures/Appendix12.svg", plot=Appendix12,
