...
summary(fr_init_kurt_89) # Significant if removing 1 outlier with kurt_std>5
# Only 3 subplots in 1989 - Use? Very similar result with a GLM
...
summary(seed_pred_kurt_89) # Significant if removing 1 outlier with kurt_std>5
# Only 3 subplots in 1989 - Use? Ssimilar result with a GLM
...
summary(sel_kurt_87)
summary(sel_kurt_88) # Significant if removing 1 outlier with kurt_std>5
summary(sel_kurt_89) # Significant if removing 1 outlier with kurt_std>5
# Only 3 subplots in 1989 - Use? Ssimilar result with a GLM
